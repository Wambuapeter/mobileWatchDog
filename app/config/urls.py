...
urlpatterns = [
    ...
    path('scan/<int:id>', views.app, name='scan'),
    path('findings/', views.findings, name='findings'),
    path('findings/<int:scan_id>', views.app, name='findings'),
    path('finding/create', views.app, name='create_finding'),
    path('finding/create/<int:scan_id>', views.app, name='create_finding'),
    path('finding/<int:id>', views.app, name='finding'),
    path('finding/edit/<int:id>', views.app, name='edit_finding'),
    path('finding/file/<int:id>', views.app, name='finding_view_file'),
    path('file/<int:id>', views.app, name='view_file'),
    ...
    path('patterns/', views.app, name="patterns"),
    path('permissions/', views.app, name="permissions"),
    path('malware/', views.app, name="malware"),
